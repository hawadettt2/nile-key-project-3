...
export function SettingsPage() {
  ...
  const [editingField, setEditingField] = useState<'userName' | 'companyName' | 'phone' | null>(null);
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex">
                        <div className="flex-grow space-y-1">
                            ...
                            <p className="pl-6 text-sm text-muted-foreground">{userProfile?.phone || t.userDataNotSet}</p>
                        </div>
                        <Button variant="ghost" size="icon" onClick={() => setEditingField('phone')} disabled={isUpdating}>
                            <Edit className="h-4 w-4" />
                        </Button>
                    </div>
